...
Η ζερίτα χρησιμοποιεί 0-9 και A-F για να γράψει τους αριθμούς σε δεκαεξαδικό, οπότε δεν υπάρχει
περίπτωση παρεξήγησης καθώς οι λέξεις χρησιμοποιούν μόνο πεζά γράμματα για να γραφούν.
...
Και τα δύο συστήματα, μετά το 999_999 χρησιμοποιούν δυνάμεις του 1_000_000 για να
δημιουργήσουν ονόματα για αυθαίρετα μεγάλους αριθμούς.
Για τις δυνάμεις μιας λέξης, αντί να χρησιμοποιήσετε τη μορφή «ad X potente»,
μπορεί να χρησιμοποιηθεί το επίθημα «-ente».
