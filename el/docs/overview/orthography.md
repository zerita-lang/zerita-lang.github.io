...
Η ζερίτα χρησιμοποιεί 22 γράμματα από το λατινικό αλφάβητο για την γραφή της,
όλα εκτός από τα q, w, x, και y.
Προφέρονται ως εξής:
...
στην λήγουσα.
Αν υπάρχει τόνος, τότε τονίζονται σε αυτήν την συλλαβή.
Για παράδειγμα, στην λέξη «homis» (άνθρωπος), το «o» είναι η τονισμένη συλλαβή,
στην λέξη «ni» (όχι) ο τόνος είναι στο «i», αλλά στην λέξη «asé»
(3ο πρόσωπο στην προσωπική αντωνυμία) ο τόνος είναι στο «e».
...
φωνητικά.
Για την διευκόλυνση του αναγνώστη, την πρώτη φορά που συναντάται ένα όνομα σε ένα
