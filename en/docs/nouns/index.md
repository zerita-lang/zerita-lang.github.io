...
Nouns in Zerita have 4 [forms][form], 5 [numbers][number] and 5 [cases][case].
The order of the prefixes and suffixes is: gender - base - form - number - case.

The [gender][gender], form, and number are the semantic parts of a zeritan noun, and the case is
purely syntactical.
