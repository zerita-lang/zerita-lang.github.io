...
Zerita uses 22 letter to spell all words, the letters of the latin
alphabet, apart from q, w, x, and y.
...
or the only syllable if the word has a single syllable.
If an accent mark is present, it signifies the stressed syllable.
For example, "homis" (human or person) has the "o" as the stressed vowel,
"ni" (no) has the "i" stressed, but "asé" (3rd person pronoun) has the "e" stressed.
