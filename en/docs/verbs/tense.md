...
A verb has the following order:

mood prefix - dictionary form - time suffix - progression suffix - person suffix
...
-   **Simple:** No suffix.
-   **Progressive:** -al suffix.
-   **Perfect:** -il suffix.
-   **Prospective:** -ol suffix.
...
1.  _potivolo e akvon in ta crepe._
    ...
    -   **explanation:** I started drinking before dusk and finished drinking after dust.
