# <x-trans>Determinatives</x-trans>

<x-trans>Determinatives are words that precede a noun, and there role is to provide
additional information about the item are referring to.</x-trans>
...
<x-trans>In zerita a determinative is mandatory, unless the noun is in the abstract form, the zero,
or the collective number, where no determinative should be used.</x-trans>
