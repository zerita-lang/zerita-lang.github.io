...
<x-trans>It is a VSO language, inspired by other latin-based languages for the
...
absence of exceptions make up for it.</x-trans>

## <x-trans>Brief overview of zerita</x-trans>

<x-trans>Zerita is meant to be a highly regular language, avoiding exceptions. It
...
Avoiding exceptions also makes it easy for machine parsing and science.</x-trans>

<x-trans>Zerita is easy, but extremely expressive. The design choice is always to
opt for the more expressive choice, even at the cost of making it more
complex, but not more complicated.</x-trans>

<x-trans>One other choice that is present throughout zeritan rule is the information
...
<x-trans>Even though zerita is using latin-based languages for the vocabulary,
...
inspiration, and is trying to be innovative on these two.</x-trans>
