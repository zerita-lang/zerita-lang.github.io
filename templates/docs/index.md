# <x-trans key="title">Zerita</x-trans>

<x-trans key="description">Zerita is a feature-rich, expressive conlang, without any exceptions.
...
## <x-trans key="overview">Brief overview of zerita</x-trans>

<x-trans key="overview-description">Zerita is meant to be a highly regular language, avoiding exceptions. It
...
## <x-trans key="features">Features of zerita</x-trans>

<x-trans key="features-description">Zerita has some unique (or rare) features:

-   4 person system
-   timeless tenses
-   factual conditionals in the past</x-trans>
