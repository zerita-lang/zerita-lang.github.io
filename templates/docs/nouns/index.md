...
<x-trans>Nouns in Zerita have 4 [forms][${form}], 5 [numbers][${number}] and 5 [cases][${case}].</x-trans>
<x-trans>The order of the prefixes and suffixes is: gender - base - form - number - case.</x-trans>

<x-trans>The [gender][${gender}], form, and number are the semantic parts of a zeritan noun, and the case is
purely syntactical.</x-trans>
