...
alphabet, apart from ${q}, ${w}, ${x}, and ${y}. They are pronounced as follows:</x-trans>
...
!!! warning "<x-trans>Pronunciation</x-trans>"
    ...
    <x-trans>Each letter's pronunciation is meant to be as in the IPA, and it doesn't
    match 100% the english sounds. The English equivalent is just the closest
    sound in English (when the word is pronounced with the received pronunciation).</x-trans>
...
(3rd person pronoun) has the "${e}" stressed.</x-trans>
